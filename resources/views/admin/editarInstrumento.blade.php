    ...
    <section id="perfilUsuario">
        <div class="texto container mt-5 mb-5 pt-2 pb-5">
            <div class="container px-5">
                <h3 class="ink px-4 pt-3 display-3 mt-3 text-center">Editar <span>publicación</span></h3>
                <div class="row">
                    <!-- Ajustes del perfil -->
                        ...
                        <div class="card py-4">
                            <div class="row">
                                <div class="container col-12 col-lg-7 p-5 pt-3 mt-1">
                                    ...
                                    <!-- Formulario -->   
                                    <form class="php-email-form" action="{{ url('/instrumento/' . $instrumento->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        {{ method_field('PATCH') }}
                                        ...
                                        <div class="form-row p-3 pt-0">
                                            ...
                                            <div class="form-group pb-2">
                                                <input type="text" name="nombre" value="{{ $instrumento->nombre }}" class="form-control text-center" id="nombre" placeholder="Introduzca un nombre" required>
                                            </div>
                                            <!-- Número de serie -->
                                            <div class="form-group pb-2">
                                                <input type="text" name="numeroSerie" value="{{ $instrumento->numeroSerie }}" class="form-control text-center" id="numeroSerie" placeholder="Introduzca un número de serie" required>
                                            </div>
                                            <!-- Año de fabricación -->
                                            <div class="form-group pb-2">
                                                <input type="text" name="anioFabricacion" value="{{ $instrumento->anioFabricacion }}" class="form-control text-center" id="anioFabricacion" placeholder="Introduzca el año de fabricación" required>
                                            </div>
                                            <!-- Descripción -->
                                            <div class="form-group py-2">
                                                <textarea class="form-control text-center" value="{{ $instrumento->descripcion }}" name="descripcion" rows="3" id="descripcion" placeholder="Introduzca una descripción"></textarea>
                                            </div>
                                            ...
                                            <!-- Nombre del dueño -->
                                            <div class="form-group pb-2">
                                                <input type="text" name="nombreOwner" value="{{ $instrumento->nombreOwner }}" class="form-control text-center" id="nombreOwner" placeholder="Introduzca el nombre del dueño" required>
                                            </div>
                                            <!-- Foto del dueño -->
                                            <div class="form-group py-2">
                                            ...
                                            <!-- Componente -->
                                            <div class="form-group pb-2">
                                                <input type="text" name="componente" value="{{ $instrumento->componente }}" class="form-control text-center" id="componente" placeholder="Introduzca un componente" required>
                                            </div>
                                            ...
                                            <div class="form-group py-2">
                                                <textarea class="form-control text-center" value="{{ $instrumento->descripcionVideo }}" name="descripcionVideo" rows="3" id="descripcionVideo" placeholder="Introduzca la descripción del vídeo"></textarea>
                                            </div>
                                            ...
                                            <!-- Título del disco -->
                                            <div class="form-group pb-2">
                                                <input type="text" name="tituloDisco" value="{{ $instrumento->tituloDisco }}" class="form-control text-center" id="tituloDisco" placeholder="Introduzca un título de disco" required>
                                            </div>
                                        </div>
        ...
        <div class="btns container d-flex justify-content-center mt-5 mb-5">
            <a href="../" class="btn col-lg-3 px-3">&nbsp;Listado de instrumentos&nbsp;</a>
        </div>
    </section>
    <!-- Footer -->
