                        ...
                        <div class="card">
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><img class="w-100" src="{{ asset('storage') . '/' . $publicacion->imagenPublicacion }}" alt="{{ $publicacion->titulo }}"></td>
                                        <td>{{ $publicacion->titulo }}</td>
                                        <td>{{ $publicacion->contenido }}</td>
                                        <td><a id="editar" href="{{ url('/publicacion/' . $publicacion->id . '/edit') }}">Editar</a></td> 
                                    </tr>    
                                    @endforeach
                                </tbody>
                            </table>
