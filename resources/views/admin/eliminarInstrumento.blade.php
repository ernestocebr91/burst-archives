                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{ url('/instrumento/' . $instrumento->id) }}" method="POST">
                                                @csrf
                                                {{ method_field('DELETE') }}
                                                <input type="submit" id="borrar" onclick="return confirm('¿Está seguro de que desea borrar el instrumento?')" value="Borrar">
                                            </form>
                                        </td>
                                    </tr>    
                                    @endforeach
