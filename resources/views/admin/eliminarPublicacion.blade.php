...
<head>
    ...
    <title>Listado de publicaciones - Burst Archives</title>
</head>
    ...
    <section id="perfilUsuario">
        <div class="texto container mt-5 mb-5 pt-2 pb-5">
            <div class="container px-5">
                <h3 class="ink px-4 pt-3 display-3 mt-3 text-center">Listado de <span>publicaciones</span></h3>
                <div class="row">
                    <!-- Ajustes del perfil -->
                        ...
                        <div class="card">
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><img class="w-100" src="{{ asset('storage') . '/' . $publicacion->imagenPublicacion }}" alt=""></td>
                                        ...
                                        <td>
                                            <form action="{{ url('/publicacion/' . $publicacion->id) }}" method="POST">
                                                @csrf
                                                {{ method_field('DELETE') }}
                                                <input type="submit" id="borrar" onclick="return confirm('¿Está seguro de que desea borrar la publicación?')" value="Borrar">
                                            </form>
                                        </td>
                                    </tr>    
                                    @endforeach
