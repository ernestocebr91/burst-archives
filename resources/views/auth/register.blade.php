    ...
    <section id="perfilUsuario">
        <div class="texto container mt-5 mb-5 pt-2 pb-5">
            <div class="container px-5">
                <h3 class="ink px-4 pt-3 display-3 mt-3 text-center">Registro de <span>usuario</span></h3>
                <div class="row">
                    <!-- Ajustes del perfil -->
                        ...
                        <div class="card py-4">
                            <div class="row">
                                <div class="container col-12 col-lg-7 p-5 pt-3 mt-1">
                                    <h4 class="ink pb-2 mt-2"><strong><span>Introduce tus datos</span></strong></h4>
                                    <!-- Formulario -->   
                                    <form method="POST" action="{{ route('register') }}">
                                        @csrf
                                        <p class="m-2 text-muted px-2">Datos personales</p>
                                        <!-- Nombre de usuario -->
                                        <div class="form-group pb-2">
                                            <input id="nombreUsuario" type="text" class="form-control text-center @error('nombreUsuario') is-invalid @enderror" name="nombreUsuario" value="{{ old('nombreUsuario') }}" placeholder="Introduzca tu nombre de usuario" required autocomplete="nombreUsuario" autofocus>
                                            @error('nombreUsuario')
                                        ...
                                        <div class="form-group py-2">
                                            <input id="password-confirm" type="password" class="form-control text-center " name="password_confirmation" placeholder="Confirme su contraseña" required autocomplete="new-password">
                                        </div>
                                        <!-- Imagen usuario -->
                                        <div class="form-group py-2">
                                            <input id="imagenUsuario" type="file" class="form-control @error('nombreUsuario') is-invalid @enderror" name="imagenUsuario" value="{{ old('imagenUsuario') }}" required autocomplete="imagenUsuario" autofocus>
