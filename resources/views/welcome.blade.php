...
<body class="d-flex flex-column min-vh-100">
    ...
    <section id="inicio" class="vh-100">
                ...
                <div id="logo" class="col-12 col-sm-11 mt-5">
                    ...
                    <div class="btns container d-flex justify-content-end">
                        <div class="container p-3">
                            <div class="row">
                                <div id="botones">
                                    <a href="{{ route('register') }}" class="btn col-lg-6 px-3">&nbsp;Regístrate&nbsp;</a>
                                    <a class="btn col-lg-6 px-3" href="{{ route('login') }}">Inicia sesión</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <br><br>
        <!-- Redes Sociales -->
        <div id="redesSociales" class="container d-flex justify-content-end w-75 pt-5 mb-5">
            <div class="row">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="container col-xl-6 col-sm-12 d-grid p-3 bg-white my-3">
                                    <img src="img/exilemainstreet.jpg" alt="exile-burst" class="w-100 d-block">
                                    <span class="ink text-muted pt-2 text-center">- Exile On Main St. Burst -</span>
                                </div>
                                <div class="container col-xl-6 col-sm-12">
                                    <h3 class="ink text-center mt-4 border-bottom border-white pb-2">Exile On Main St. <span>Burst</span></h3>
                                    <h4 class="text-muted px-1 text-center d-flex justify-content-center ink mt-3">#? ????</h4>
                                    <div class="container d-flex justify-content-center">
                                        <p>Esta guitarra fue utilizada por <span class="logo ink">The <span>Rolling Stones </span></span> durante las sesiones de grabación de su disco <span class="logo ink">Exile On Main Street&nbsp;<span> (1972)</span></span>, de ahí el apodo de la misma. Con ella, grabaron diferentes partes de canciones tanto <span class="logo ink">Keith <span>Richards</span></span> como <span class="logo ink">Mick <span>Taylor</span></span>.<br>Un aspecto a destacar es que, debido a una reparación, se perdió el número de serie. Actualmente, la guitarra es propiedad de un coleccionista anónimo.</p>
                                    </div>
                                    <div class="container d-flex justify-content-center mt-4">
                                        <img src="img/exileonmainstreet.jpg" alt="exile-on-main-street" class="w-75 d-block text-center">
                                    </div>
                                    <p class="pt-3 text-center"><span class="logo ink">The Rolling Stones - <span> Exile On Main Street (1972)</span></span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="container col-sm-10 col-md-6 col-xl-4 p-4 text-center mt-0">
                        <div class="card py-4">
                            ...
                            <div class="container p-3 pb-3">
                                <h4 class="ink pb-2"><strong>Publicación de <span>instrumento</span></strong></h4>
                                <p class="text-muted small px-1">Podrás publicar una ficha de algún instrumento y colaborar en la web.</p>
                            </div>
                        </div>
                    </div>
                    <!-- Acceso completo -->
        ...
        <div id="formulario" class="container mt-5 mb-5">
            <div class="row">
                <div class="texto col-xl-6 col-sm-12 text-justify pt-3 pb-5 p-sm-4">
                    ...
                    <!-- Formulario -->   
                    <form class="php-email-form" action="{{ asset('contacto.php') }}" method="POST">
